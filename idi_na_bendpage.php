...
require('sharewithall.php');
			...
			else if($k==1) //AKO BEND POSTOJI POKAZI MI NJEGOVU STRANICU:
	{
			...
			<form method = "post" action = "idi_na_profil.php"  >
...
<div class="w3-dropdown-click  w3-black w3-card" >
    ...
    <div id="Demo1" class="w3-dropdown-content w3-bar-block w3-hide ">
      <a class="w3-bar-item " style="width: 717;"><?php echo $podaci_o_bendu[5]; ?></a>
	</div>
	...
	for($i=0; $i<count($albumi); $i++){
			...
			?>
				...
				<a class="w3-bar-item " style="width: 717;"><h2><?php echo $tralbum."<br/>"; ?></h2></a>
			...
			while($row = mysqli_fetch_array($result1))
			{
				...
				<a class="w3-bar-item " style="width: 717;"><?php echo $ime_pesme; ?></a>
	 ...
	 <button onclick="myFunction('Demo3')" class="w3-button w3-padding-large w3-black" style="width: 175;">Clanovi</button>
	...
	<?php
		...
		mysqli_select_db($con,"bendovi");
			...
			<a class="w3-bar-item " style="width: 717;"><?php echo $ime_clana; ?></a>	
	...
	<?php
		...
		mysqli_select_db($con,"bendovi");
			...
			while($row = mysqli_fetch_array($result1))
			{
				...
				<a href="<?php echo $link; ?>" class="w3-bar-item " style="width: 717;"><?php echo $link; ?></a>	
