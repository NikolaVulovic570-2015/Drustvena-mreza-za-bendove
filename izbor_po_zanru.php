<html>
<head>
<title>Izbor benda po žanru</title>
<meta charset="UTF-8">
...
if (isset($_POST['button']))
	...
	$con = mysqli_connect("localhost","root","");
			...
			$qry = "SELECT * FROM tabela WHERE zanr = '".$izbor."'";
			...
			<br/><br/>
             ...
             <div class="header">
			<h2 class="w3-animate-zoom" style="margin: 20px 0px 20px 0px; text-align: center;">Pretraga bendova po žanru: <?php echo $izbor;?></h2>
			<?php
