...
if (isset($_POST['button']))
	...
	$con = mysqli_connect("localhost","root","");
			...
			$qry = "SELECT * FROM tabela WHERE grad = '".$izbor."'";
			...
			<br/><br/>
             ...
             <div class="header">
			<h2 class="w3-animate-zoom" style="margin: 20px 0px 20px 0px; text-align: center;">Pretraga benda po gradu: <?php echo $izbor;?></h2>
			<?php
